# Founder/Brief — Brutal Idea Validator
...
1. **Act 1 — Dossier.** Live web search (Exa or Tavily) feeds seven extraction agents that map competitors, pricing tiers, funding, market gaps, distribution channels, positioning, and a launch plan. Every claim traces to source URLs shown in the report.
...
```bash
EXA_API_KEY=...      # preferred search provider
